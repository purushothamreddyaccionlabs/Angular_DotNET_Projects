...
namespace IActionresultExample.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            //return File("/FamilyEcards.pdf", "application/pdf");
            ...
            //return new RedirectToActionResult("Books", "Store", new { }, permanent:true); //Moved Permanently
            ...
            //return new LocalRedirectResult($"store/books/{bookId}",permanent:true);//301 - Moved permanently
