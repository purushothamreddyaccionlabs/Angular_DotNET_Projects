(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('ng-image-video-gallery', ['exports', '@angular/core', '@angular/common', '@angular/platform-browser', '@angular/common/http'], factory) :
    (global = global || self, factory(global['ng-image-video-gallery'] = {}, global.ng.core, global.ng.common, global.ng.platformBrowser, global.ng.common.http));
}(this, (function (exports, core, common, platformBrowser, http) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgImageSliderComponent = /** @class */ (function () {
        function NgImageSliderComponent(cdRef, platformId, imageSliderService, elRef) {
            ...
            this.thumbnailArrowClick = new core.EventEmitter();
        ...
        NgImageSliderComponent.propDecorators = {
            ...
            thumnailSliderMain: [{ type: core.ViewChild, args: ['thumnailSliderMain', { static: false },] }],
            isShowThumbnailImage: [{ type: core.Input }],
            isThumbnailbSlider: [{ type: core.Input }],
            imageSize: [{ type: core.Input }],
            thumbnailSize: [{ type: core.Input }],
    ...
    if (false) {
        ...
        /** @type {?} */
        NgImageSliderComponent.prototype.thumbnailSliderMainDivWidth;
        /** @type {?} */
        NgImageSliderComponent.prototype.imageParentDivWidth;
        /** @type {?} */
        NgImageSliderComponent.prototype.thumbnailParentDivWidth;
        /** @type {?} */
        ...
        /** @type {?} */
        NgImageSliderComponent.prototype.thumbnailLeftPos;
        /** @type {?} */
        ...
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderThumbnailPrevDisable;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderNextDisable;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderThumbnailNextDisable;
        /** @type {?} */
        NgImageSliderComponent.prototype.slideImageCount;
        /** @type {?} */
        NgImageSliderComponent.prototype.slideThumbnailCount;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderImageWidth;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderThumbnailWidth;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderImageReceivedWidth;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderThumbnailReceivedWidth;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderImageHeight;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderHeight;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderImageReceivedHeight;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderThumbnailReceivedHeight;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderImageSizeWithPadding;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderThumbnailSizeWithPadding;
        /** @type {?} */
        ...
        /** @type {?} */
        NgImageSliderComponent.prototype.thumbnailMargin;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderOrderType;
        /** @type {?} */
        NgImageSliderComponent.prototype.thumbnailImages;
        /** @type {?} */
        NgImageSliderComponent.prototype.thmbnailImageIndex;
        /** @type {?} */
        NgImageSliderComponent.prototype.thumbnailLastIndex;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderLastIndex;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderIndex;
        /** @type {?} */
        NgImageSliderComponent.prototype.thumbnailIndex;
        /** @type {?} */
        NgImageSliderComponent.prototype.infiniteSliderThumbnail;
        /** @type {?} */
        NgImageSliderComponent.prototype.infiniteThumbnailImageIndex;
        /** @type {?} */
        NgImageSliderComponent.prototype.leftPosition;
        /** @type {?} */
        NgImageSliderComponent.prototype.closeLightbox;
        /**
         * @type {?}
        ...
        /** @type {?} */
        NgImageSliderComponent.prototype.visiableThumbnailIndex;
        /** @type {?} */
        NgImageSliderComponent.prototype.sliderMain;
        /** @type {?} */
        NgImageSliderComponent.prototype.imageDiv;
        /** @type {?} */
        NgImageSliderComponent.prototype.thumnailSliderMain;
        /** @type {?} */
        NgImageSliderComponent.prototype.isShowThumbnailImage;
        /** @type {?} */
        NgImageSliderComponent.prototype.isThumbnailbSlider;
        /** @type {?} */
        ...
        /** @type {?} */
        NgImageSliderComponent.prototype.thumbnailArrowClick;
        /** @type {?} */
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/services/slider.service.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var SliderService = /** @class */ (function () {
         ...
         * @return {?}
         */
        SliderService.prototype.getoEmbedResponse = /**
         * @param {?} url
         * @param {?} videoUrl
         * @return {?}
         */
        function (url, videoUrl) {
            return this.http.get(url + videoUrl);
        };
        SliderService.decorators = [
        ...
        /** @nocollapse */ SliderService.ɵprov = core.ɵɵdefineInjectable({ factory: function SliderService_Factory() { return new SliderService(core.ɵɵinject(http.HttpClient)); }, token: SliderService, providedIn: "root" });
    ...
    /** @type {?} */
    var vimeoRegExp = /\/\/(?:www.)?vimeo.com\/([0-9a-z-_]+)/i;
    /** @type {?} */
    var wistiaRegExp = /https?:\/\/[^.]+\.(wistia\.com|wi\.st)\/(medias|embed)\/.*/;
    var SliderCustomImageComponent = /** @class */ (function () {
        function SliderCustomImageComponent(imageSliderService, sanitizer, document, sliderService) {
            this.imageSliderService = imageSliderService;
            ...
            this.ratio = false;
            this.lazy = false;
            this.getThumbnail = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        function () {
            ...
            /** @type {?} */
            var matchVimeoUrl = url.match(vimeoRegExp);
            /** @type {?} */
            var matchWistiaUrl = url.match(wistiaRegExp);
            if (match && match[2].length === 11) {
                if (this.showVideo) {
                    ...
                    /** @type {?} */
                    var thumnailObject = { index: this.imagePositionInSlider, image: this.fileUrl };
                ...
                function (res) {
                    if (_this.showVideo) {
                        _this.type = _this.ANOTHER_VIDEO;
                        /** @type {?} */
                        var vimeoVideoUrl = "" + 'https://player.vimeo.com/video/' + res['video_id'];
                        _this.videoUrl = _this.sanitizer.bypassSecurityTrustResourceUrl(vimeoVideoUrl);
                    }
                    else {
                        _this.type = _this.IMAGE;
                        _this.videoUrl = _this.sanitizer.bypassSecurityTrustResourceUrl(res['thumbnail_url']);
                        /** @type {?} */
                        var thumnailObject = { index: _this.imagePositionInSlider, image: _this.videoUrl };
                        _this.getThumbnail.emit(thumnailObject);
                    }
                }));
            }
                ...
                if (this.showVideo) {
                    ...
                    /** @type {?} */
                    var thumnailObject = { index: this.imagePositionInSlider, image: this.videoUrl };
                    this.getThumbnail.emit(thumnailObject);
                }
            }
                ...
                function (res) {
                    if (_this.showVideo) {
                        _this.type = _this.ANOTHER_VIDEO;
                        _this.wistiaUrl = url + "?resumable=false";
                        _this.videoUrl = _this.sanitizer.bypassSecurityTrustResourceUrl(_this.wistiaUrl);
                    }
                    else {
                        _this.type = _this.IMAGE;
                        _this.videoUrl = _this.sanitizer.bypassSecurityTrustResourceUrl(res['thumbnail_url']);
        ...
        SliderCustomImageComponent.propDecorators = {
            ...
            imgData: [{ type: core.Input }],
            imgHeight: [{ type: core.Input }],
            getThumbnail: [{ type: core.Output }],
            imagePositionInSlider: [{ type: core.Input }]
        };
    ...
    var SliderLightboxComponent = /** @class */ (function () {
        function SliderLightboxComponent(cdRef, sanitizer, elRef, document) {
            ...
            this.closeLightBox = new core.EventEmitter();
        }
        ...
        SliderLightboxComponent.propDecorators = {
            ...
            lightboxTextDiv: [{ type: core.ViewChild, args: ['lightboxTextDiv', { static: false },] }],
            images: [{ type: core.Input }],
            imageIndex: [{ type: core.Input }],
            ...
            closeLightBox: [{ type: core.Output }],
            onResize: [{ type: core.HostListener, args: ['window:resize', ['$event'],] }],
            handleKeyboardEvent: [{ type: core.HostListener, args: ['document:keyup', ['$event'],] }]
        };
    ...
    exports.ɵb = SliderService;
    exports.ɵc = SliderLightboxComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ng-image-video-gallery.umd.js.map
