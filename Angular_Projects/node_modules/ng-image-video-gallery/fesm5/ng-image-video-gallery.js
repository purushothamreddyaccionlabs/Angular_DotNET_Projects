import { Injectable, EventEmitter, Component, ViewEncapsulation, ChangeDetectorRef, Inject, PLATFORM_ID, ElementRef, ViewChild, Input, Output, HostListener, ɵɵdefineInjectable, ɵɵinject, NgModule } from '@angular/core';
...
var NgImageSliderComponent = /** @class */ (function () {
    ...
    NgImageSliderComponent.propDecorators = {
        ...
        thumnailSliderMain: [{ type: ViewChild, args: ['thumnailSliderMain', { static: false },] }],
        isShowThumbnailImage: [{ type: Input }],
        isThumbnailbSlider: [{ type: Input }],
        imageSize: [{ type: Input }],
        thumbnailSize: [{ type: Input }],
        infinite: [{ type: Input }],
        ...
        thumbnailArrowClick: [{ type: Output }],
...
var SliderService = /** @class */ (function () {
    ...
    /** @nocollapse */ SliderService.ɵprov = ɵɵdefineInjectable({ factory: function SliderService_Factory() { return new SliderService(ɵɵinject(HttpClient)); }, token: SliderService, providedIn: "root" });
...
/**
 * @fileoverview added by tsickle
 * Generated from: ng-image-video-gallery.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */

export { NgImageSliderComponent, NgImageSliderModule, NgImageSliderService, SliderCustomImageComponent as ɵa, SliderService as ɵb, SliderLightboxComponent as ɵc };
//# sourceMappingURL=ng-image-video-gallery.js.map
